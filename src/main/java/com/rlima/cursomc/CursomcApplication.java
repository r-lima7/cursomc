...
public class CursomcApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		p1.getCategorias().addAll(Arrays.asList(cat1, cat4)); //agora os produtos conhecem sua categoria 
		...
		categoriaRepository.saveAll(Arrays.asList(cat1, cat2, cat3, cat4, cat5, cat6, cat7)); //salva todas as categorias e os produtos criados e relacionados
