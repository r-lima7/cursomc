...
public class Produto implements Serializable {
	...
	@JsonIgnore // a partir do ItemPedido ja tem acesso ao produto, ja atende a logica da aplicacao
	...
	public Produto(Integer id, String nome, Double preco) { // Categoria não entra no cont.
		super();
		this.id = id;
		this.nome = nome;
		this.preco = preco;
	...
	@JsonIgnore //todo metodo get e serializado por padrao, ha a necessidade de corrigir a referencia ciclica
